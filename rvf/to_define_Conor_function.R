...
run_one = function(number.mosquitoes, parameter.file = file.choose(), 
                   initial.mosquito.numbers, times = seq(0, 5, 0.0002), 
    ...
    if (number.mosquitoes == 1) {
        ...
        Y0 <- c(Sh = 500, Eh = 5, Ih = 5, Rh = 0, 
                Nv = initial.mosquito.numbers[1] , 
                Ev1 = 0, Ev2 = 0, Ev3 = 0, Iv = 0)
        if (length(params) == 14){
        ...
        Y0 <- c(Sh = 500, Eh = 5, Ih = 5, Rh = 0, 
                N1v = initial.mosquito.numbers[1] , 
                E1v1 = 0, E1v2 = 0, E1v3 = 0, I1v = 0, 
                N2v = initial.mosquito.numbers[2] , 
                E2v1 = 0, E2v2 = 0, E2v3 = 0, I2v = 0)
        if (length(params) == 17){
        ...
        Y0 <- c(Sh = 500, Eh = 5, Ih = 5, Rh = 0, 
                ...
                N2v = initial.mosquito.numbers[2], 
                E2v1 = 0, E2v2 = 0, E2v3 = 0, I2v = 0, 
                N3v = initial.mosquito.numbers[3],
                E3v1 = 0, E3v2 = 0, E3v3 = 0, I3v = 0)
        if (length(params) == 20){
